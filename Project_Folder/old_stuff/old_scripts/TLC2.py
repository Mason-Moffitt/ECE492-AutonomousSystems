...
HORIZONTAL_TOLERANCE = 25.0  # Horizontal distance to consider start location reached (meters)
...
def navigate_to_start_location(vehicle, start_location):
    ...
    while True:
        ...
        if distance < HORIZONTAL_TOLERANCE and alt_diff < VERTICAL_TOLERANCE:
            print("Starting location reached. Switching to LOITER mode...")
            break
