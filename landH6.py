...
def main():
    ...
    # Switch to LAND mode and make sure the throttle is zero, letting the plane glide
    print("Switching to LAND mode and gliding to the landing point...")
    vehicle.mode = VehicleMode("LAND")
    while vehicle.mode != "LAND":
        print(" Waiting for mode change to LAND...")
        time.sleep(1)

    print("Landing initiated. Plane should glide to the landing point without throttle.")
