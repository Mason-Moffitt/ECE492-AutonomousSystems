...
K_P = 0.1                 # Pitch gain
K_HEADING = 0.9           # Heading gain for circling
K_DISTANCE = 0.15         # Distance correction gain for radius control
...
def glide_to_waypoint(vehicle, waypoint):
    ...
    while (current_alt > IDEAL_HEIGHT and current_speed > SAFE_AIRSPEED and
        ...
        # Enhanced bank angle for consistent radius
        ...
        desired_bank = 0.7 * last_bank + 0.3 * desired_bank  # Smooth transitions
