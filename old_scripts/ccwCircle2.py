...
K_HEADING = 0.8           # Heading error gain for tangent alignment .6works
K_DISTANCE = 0.1          # Distance correction gain for bank angle .2works
...
K_HEADING_INITIAL = 0.8   # Aggressive heading gain for initial turn
